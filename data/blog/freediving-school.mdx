...
This project was fun and I wanted it to be educational for the mostly. The accent here is on functionality not on design.

The users would mostly want the application to be fast and responsive.
...
I basically build this project from scratch.
