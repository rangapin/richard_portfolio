...
import logoPokerStars from '@/images/logos/pokerstars.svg'
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'Run It Once Poker',
      title: 'Support & Responsible Gaming',
      logo: logoRunItOnce,
      start: '2019',
      end: '2022',
    },
    {
      company: 'PokerStars',
      title: 'Responsible Gaming & Customer Support',
      logo: logoPokerStars,
      start: '2010',
      end: '2019',
    },
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="/richard.angapin_gtm.pdf" variant="secondary" className="group mt-6 w-full">
        Download CV
  ...
  return (
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[image5, image2, image4].map((image, imageIndex) => (
          <div
            key={image.src}
            className={clsx(
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            GTM Engineer, founder, and amateur freediver.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I'm Richard, a GTM engineer and founder based in Gdynia, Poland. I
            build the outbound infrastructure that turns raw data into pipeline —
            enrichment workflows, sequencing systems, and the API integrations
            that help B2B teams reach the right people at the right time.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/rangapin"
