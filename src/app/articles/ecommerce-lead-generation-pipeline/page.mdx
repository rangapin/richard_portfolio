...
export const article = {
  ...
  date: '2026-02-20',
  title: 'E-commerce lead generation and personalization pipeline',
  description:
    'A full Clay workflow that takes raw company names through qualification, contact discovery, email enrichment, and personalized outreach copy — ready to plug into any sequencing tool.',
}
...
<img src="/articles/ecommerce-lead-generation/companies-table.png" alt="E-commerce companies table in Clay showing qualification results" className="rounded-2xl" />
...
<img src="/articles/ecommerce-lead-generation/decision-makers-table.png" alt="Decision makers table in Clay showing 64 contacts with verified emails" className="rounded-2xl" />
